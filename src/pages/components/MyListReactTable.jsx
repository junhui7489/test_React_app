...
class MyListReactTable extends React.Component{
  constructor(props){
      super(props);
      this.state = {newPage: 0, page: 0, rowsPerPage: 10, buttonToggle1: false, 
        buttonToggle2: false, buttonToggle3: false, buttonToggle4: false, buttonToggle5: false, ownedItems: [] };
  }
...
MyListReactTable.propTypes = {
  data: PropTypes.array
};

MyListReactTable.defaultProps = {
  data: [
    {
      albumId: 2,
      id: 85,
